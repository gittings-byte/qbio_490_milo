...
1. Open your terminal and cd into the sp26_course_materials directory
...
knitr::opts_knit$set(root.dir = normalizePath("/home1/gittings/Week03_R")) #TODO: edit this to show your path
```
...
vector <- c('brown', 'black', 'red', 'yellow')
...
age <- 19
birthday <- 04/16/2006
three_fav_colors <- c('navyblue', 'darkred', 'forestgreen')
name
age
birthday
three_fav_colors
...
```{r Exercise 5.2}
"cat" == "cat" & "dog" == "dog" # TODO: make a prediction: True
"cat" == "cat" & "fish" == "hamster" # TODO: make a prediction: False

1 < 2 | 3 < 1 # TODO: make a prediction: True
1 < 2 | 3 < 5 # TODO: make a prediction: True
